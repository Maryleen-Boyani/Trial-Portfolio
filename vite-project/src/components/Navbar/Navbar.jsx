    ...
    return(
        <div className="text-wrap">
            <header className="flex h-14 justify-between p-2  ">
                ...
                <nav ref={NavRef} className="flex justify-center font-serif text-xl text-wrap ">
                    ...
                    <button className="text-white bg-gradient-to-r from-purple-600 via-purple-900 to-purple-950 p-1 text-xl rounded-full ">
                        Hire me!
                    </button>
